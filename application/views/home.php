                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="mega-menu-item">
                                                        ...
                                                        <ul class="menu-list">
                                                            <li><a href="product-inner-zoom.html" class="menu-link-text link">Koleksi Kaftan</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <div class="mega-menu-item">
                                                        ...
                                                        <ul class="menu-list">
                                                            <li><a href="product-color-swatch.html" class="menu-link-text link">Koleksi Kemeja</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <div class="mega-menu-item">
                                                        ...
                                                        <ul class="menu-list">
                                                            <li><a href="product-frequently-bought-together.html" class="menu-link-text link">Koleksi Kaftan Sepasang</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            <img src="<?= base_url(); ?>assets/images/slider/fashion-slideshow-01.jpg" alt="fashion-slideshow">
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="shop-default.html" class="collection-image img-style">
                                                <img class="lazyload" data-src="<?= base_url()?>assets/images/collections/collection-17.jpg" src="images/collections/collection-17.jpg" alt="collection-img">
                                            </a>
                                            <div class="collection-content">
                                                <a href="shop-default.html" class="tf-btn collection-title hover-icon fs-15"><span>Kain Sarung</span><i class="icon icon-arrow1-top-left"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="shop-default.html" class="collection-image img-style">
                                                <img class="lazyload" data-src="<?= base_url()?>assets/images/collections/collection-14.jpg" src="images/collections/collection-14.jpg" alt="collection-img">
                                            </a>
                                            <div class="collection-content">
                                                <a href="shop-default.html" class="tf-btn collection-title hover-icon fs-15"><span>Kaftan</span><i class="icon icon-arrow1-top-left"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="shop-default.html" class="collection-image img-style">
                                                <img class="lazyload" data-src="<?= base_url()?>assets/images/collections/collection-18.jpg" src="images/collections/collection-18.jpg" alt="collection-demo-1">
                                            </a>
                                            <div class="collection-content">
                                                <a href="shop-default.html" class="tf-btn collection-title hover-icon fs-15"><span>Kemeja</span><i class="icon icon-arrow1-top-left"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="shop-default.html" class="collection-image img-style">
                                                <img class="lazyload" data-src="<?= base_url()?>assets/images/collections/collection-15.jpg" src="images/collections/collection-15.jpg" alt="collection-demo-1">
                                            </a>
                                            <div class="collection-content">
                                                <a href="shop-default.html" class="tf-btn collection-title hover-icon fs-15"><span>Kaftan Sepasang</span><i class="icon icon-arrow1-top-left"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
