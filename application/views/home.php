                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="shop-default.html" class="collection-image img-style">
                                                <img class="lazyload" data-src="<?= base_url();?>assets/images/homepage/kain-sarung.jpg" src="<?= base_url();?>assets/images/homepage/kain-sarung.jpg" alt="collection-img">
                                            </a>
                                ...
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="shop-default.html" class="collection-image img-style">
                                                <img class="lazyload" data-src="<?= base_url();?>assets/images/homepage/kaftan.jpg" src="<?= base_url();?>assets/images/homepage/kaftan.jpg" alt="collection-img">
                                            </a>
                                            <div class="collection-content">
                                ...
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="shop-default.html" class="collection-image img-style">
                                                <img class="lazyload" data-src="<?= base_url();?>assets/images/homepage/kemeja.jpg" src="<?= base_url();?>assets/images/homepage/kemeja.jpg" alt="collection-demo-1">
                                            </a>
                                            <div class="collection-content">
                                ...
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="shop-default.html" class="collection-image img-style">
                                                <img class="lazyload" data-src="<?= base_url();?>assets/images/homepage/kaftan-sepasang.jpg" src="<?= base_url();?>assets/images/homepage/kaftan-sepasang.jpg" alt="collection-demo-1">
                                            </a>
                                            <div class="collection-content">
